...
3. У каждой задачи в методе run вызови метод doExpensiveOperation с порядковым номером задачи начиная с 1, см.
пример вывода.
...
public class Solution
{
    public static void main(String[] args) throws InterruptedException
    {
        ...
        ThreadPoolExecutor executor = new ThreadPoolExecutor(3,5,1000,TimeUnit.MILLISECONDS,lbq);
