...
public class Solution {
    ...
    public static volatile AtomicInteger globalFactoryNumber = new AtomicInteger(0);
    ...
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        {
            synchronized (Solution.globalFactoryNumber)
            {
                this.factoryNumber = Solution.globalFactoryNumber;
                Solution.globalFactoryNumber.incrementAndGet();
            }
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            // Имя треда "GN-pool-A-thread-B"
            String GN = t.getThreadGroup().getName();
            t.setName(GN + "-pool-" + this.factoryNumber + "-thread-" + threadNumber);
