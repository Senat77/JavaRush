...
5. Метод refreshAllData в классе TaskDataProvider должен сохранять в список tasks результат работы метода getFakeTasks
    класса DbMock.
6. Метод refreshAllData в классе NameDataProvider должен сохранять в список names результат работы метода getFakeNames
    класса DbMock.
*/
public class Solution
{
    ...
    private class TaskDataProvider extends DbMock implements DbDataProvider<Task>
    {
        ...
        {
            //if (DbMock.getFakeTasks(criteria) != null)
