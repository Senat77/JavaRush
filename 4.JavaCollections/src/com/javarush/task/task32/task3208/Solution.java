...
4. Для Cat и Dog нужно добавить в registry связь уникального текстового ключа и Remote объекта используя
registry.bind (String, Remote).
5. При возникновении любого исключения нужно вывести его стек-трейс в поток System.err используя метод
printStackTrace ().
*/
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable()
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                final Cat cat_service = new Cat("Cat");
                final Dog dog_service = new Dog("Dog");
                Remote cat_stub = UnicastRemoteObject.exportObject(cat_service, 0);
                Remote dog_stub = UnicastRemoteObject.exportObject(dog_service,0);
                registry.bind("Cat",cat_stub);
                registry.bind("Dog",dog_stub);
            }
