...
6. Метод writeString(String s) класса AdapterFileOutputStream должен делегировать полномочие такому же методу
    fileOutputStream.
...
public class AdapterFileOutputStream implements AmigoStringWriter
{
    ...
    public AdapterFileOutputStream (FileOutputStream aFileOutputStream)
    {
