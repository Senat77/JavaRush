...
2. В методе cleanAllApartments для всех однокомнатных аппартаментов(Apt1Room) содержащихся в списке необходимо вызвать
    метод clean1Room.
3. В методе cleanAllApartments для всех двухкомнатных аппартаментов(Apt2Room) содержащихся в списке необходимо вызвать
    метод clean2Rooms.
4. В методе cleanAllApartments для всех трехкомнатных аппартаментов(Apt3Room) содержащихся в списке необходимо вызвать
    метод clean3Rooms.
...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments)
    {
        ...
        {
            if (app instanceof Apt1Room) ((Apt1Room) app).clean1Room();
            if (app instanceof Apt2Room) ((Apt2Room) app).clean2Rooms();
            if (app instanceof Apt3Room) ((Apt3Room) app).clean3Rooms();
        }
    }
