...
пляж лучше (положительное число)
...
public class Beach implements Comparable<Beach>
{
    ...
    {
        int result = Integer.compare(this.getQuality(),o.getQuality()) - Float.compare(this.getDistance(),o.getDistance());
        return result;
        /*
        int res = 0;
        if(this.distance == o.distance && this.quality == o.quality) return 0;
        if (this.distance > o.distance) res++;
        else res--;
        if (this.quality > o.quality) res++;
        else res--;
        return res;
        */
    }
