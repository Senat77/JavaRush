...
6. Метод run класса Violin должен выводить на консоль продолжительность игры в миллисекундах. Используй формат
    из примера.
*/
...
public class Solution
{
    ...
    public static class Violin implements MusicalInstrument
    {
        ...
        public void run()
        {
            Date sP = startPlaying();
            Solution.sleepNSeconds(1);
            Date eP = stopPlaying();

            System.out.println("Playing " + (eP.getTime() - sP.getTime()) + " ms");
        }
